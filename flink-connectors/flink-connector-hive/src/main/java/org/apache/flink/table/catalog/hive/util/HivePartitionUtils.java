...
public class HivePartitionUtils {
	...
	/**
	 * Returns all HiveTablePartitions of a hive table, returns single HiveTablePartition
	 * if the hive table is not partitioned.
	 */
	...
	private static Object restorePartitionValueFromType(HiveShim shim, String valStr, DataType type) {
		LogicalTypeRoot typeRoot = type.getLogicalType().getTypeRoot();
	...
	public static List<Tuple2<List<String>, Long>> getAllPartValueToTimeList(PartitionFetcher.Context context) {
