...
_GROUPWINDOW = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shift_timezone', full_name='org.apache.flink.fn_execution.v1.GroupWindow.shift_timezone', index=9,
