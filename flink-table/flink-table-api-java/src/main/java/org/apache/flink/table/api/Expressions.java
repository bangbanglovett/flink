...
public final class Expressions {
     ...
     * the underlying function return type is {@link DataTypes#DATE()}.
     */
     ...
     * the underlying function return type is {@link DataTypes#TIME()}.
     */
     ...
     * */
    public static ApiExpression now() {
        return apiCall(BuiltInFunctionDefinitions.NOW);
    }

    /**
     * Returns the current SQL time in local time zone,
     * the underlying function return type is {@link DataTypes#TIME()},
     * this is a synonym for {@link Expressions#currentTime()}.
     */
    ...
    /**
     * Returns the current SQL timestamp in local time zone,
     * the underlying function return type is {@link DataTypes#TIMESTAMP()}.
     * */
