...
public class CumulativeWindowAssignerTest {
    ...
    public void testWindowAssignment() {
        ...
        assertThat(
                ...
                contains(timeWindow(5000, 6000), timeWindow(6000, 7000), timeWindow(7000, 8000)));
        ...
        assertEquals(
                assigner.getLastWindow(new TimeWindow(7000, 8000)), new TimeWindow(5000, 10000));
    }
    ...
    public void testWindowAssignmentWithOffset() {
        ...
        assertThat(
                ...
                contains(timeWindow(5100, 6100), timeWindow(6100, 7100), timeWindow(7100, 8100)));
        ...
        assertEquals(
                assigner.getLastWindow(new TimeWindow(7100, 8100)), new TimeWindow(5100, 10100));
    }
