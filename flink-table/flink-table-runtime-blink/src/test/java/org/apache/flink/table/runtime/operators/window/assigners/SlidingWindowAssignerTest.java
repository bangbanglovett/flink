...
public class SlidingWindowAssignerTest {
    ...
    public void testWindowAssignment() {
        ...
        assertEquals(
                assigner.getLastWindow(new TimeWindow(4000, 5000)), new TimeWindow(4000, 9000));
        assertEquals(
                assigner.getLastWindow(new TimeWindow(2000, 3000)), new TimeWindow(2000, 7000));
    }
    ...
    public void testWindowAssignmentWithOffset() {
        ...
        assertEquals(
                assigner.getLastWindow(new TimeWindow(4100, 5100)), new TimeWindow(4100, 9100));
        assertEquals(
                assigner.getLastWindow(new TimeWindow(2100, 3100)), new TimeWindow(2100, 7100));
    }
