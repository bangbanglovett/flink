...
//        assertEquals(Collections.emptyList(), toBeMergedSlices(assigner, 1000L)); // the first
// slice
//
...
//        assertEquals(Collections.emptyList(), toBeMergedSlices(assigner, 6000L)); // the first
// slice
//
...
//        assertErrorMessage(
//                () -> SliceAssigners.cumulative(0, Duration.ofSeconds(-5), Duration.ofSeconds(1)),
//                "Cumulative Window parameters must satisfy maxSize > 0 and step > 0, but got
// maxSize -5000ms and step 1000ms.");
//
//        assertErrorMessage(
//                () -> SliceAssigners.cumulative(0, Duration.ofSeconds(5), Duration.ofSeconds(-1)),
//                "Cumulative Window parameters must satisfy maxSize > 0 and step > 0, but got
...
//                "Cumulative Window requires maxSize must be an integral multiple of step, but got
// maxSize 5000ms and step 2000ms.");
//
//        // should pass
