...
public class TumblingSliceAssignerTest extends SliceAssignerTestBase {
    ...
    public void testSliceAssignment() {
        SliceAssigner assigner =
                SliceAssigners.tumbling(0, timeZone.getRawOffset(), Duration.ofHours(5));
    ...
    public void testInvalidParameters() {
        assertErrorMessage(
                () -> SliceAssigners.tumbling(0, timeZone.getRawOffset(), Duration.ofSeconds(-1)),
                "Tumbling Window parameters must satisfy size > 0, but got size -1000ms.");

        assertErrorMessage(
                () ->
                        SliceAssigners.tumbling(0, timeZone.getRawOffset(), Duration.ofSeconds(10))
